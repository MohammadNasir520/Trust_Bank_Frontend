...
import { useStudentAccountMutation } from "@/redux/api/accountApi";
                  ...
                  <div>
                    ...
                    <div className="mt-4 grid grid-cols-1 gap-y-4 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 items-center justify-center">
                      ...
                      <div className="sm:col-span-1 flex justify-center">
                        <div>
                          <FormInput
                            name="localGuargianNid"
                            label="Local Guardian NID"
                            placeholder="Local Guardian NID"
                            className="w-[300px] h-[45px] text-sm px-2 py-3 focus:bg-gray-100 border border-gray-200 rounded-lg focus:outline-none focus:border-[#012169]"
                          />
                        </div>
                      </div>
                      ...
                      <div className="sm:col-span-1 flex justify-center">
                        <div>
                          <FormTextArea
                            name="localGuargianAddress"
                            label="Local Guargian Address"
                            placeholder="Local Guargian Address"
