    ...
    return (
      <div className="py-8 ">
        ...
        <div className="my-3 pl-6 lg:pl-24 bg-[#F5F5F5]">
          <h3>
            If you’re an existing NAB customer, save time by using your NAB ID
            to:
          </h3>
        ...
        <div className="my-3 flex flex-col gap-2 pl-6 lg:pl-24 bg-[#F5F5F5]">
          ...
          <p>
            You can upload your supporting financial information documents in
            the application form. If you can’t upload your documents, the
            confirmation email we send will outline other ways you can provide
            the documents.
          </p>
        ...
        <div className="my-3 flex flex-col gap-2 pl-6 lg:pl-24 bg-[#F5F5F5]">
          ...
          <p className="flex items-center gap-1">
            <RxCrossCircled color="red" />
            Business purposes. Explore our business loans or discuss further
        ...
        <div className="my-3 flex flex-col gap-2 pl-6 lg:pl-24 bg-[#F5F5F5]">
          ...
          <p className="flex items-center gap-2">
            ...
            We’ll verify your information: Depending on your circumstances, we
            may do other checks and contact you for further information.
          </p>
          <p className="flex items-center gap-2">
            <TbCircleNumber3 size={25} />
            Accept your offer: If you’re approved and accept our loan offer
            through NAB Internet Banking, your money will be ready in one
            business day.
          </p>
        </div>
