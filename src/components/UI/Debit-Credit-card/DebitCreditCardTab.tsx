  ...
  return (
    <div className="bg-blue-700 min-h-screen ">
      <Tabs size="md" variant="enclosed" className="px-[150px] py-3">
        <TabList className=" backdrop-blur-md bg-white/30 text-white rounded-t-xl ">
          {tabData?.map((tab) => (
            <Tab
              className="flex items-center justify-center h-20 w-20 relative text-blue-950  hover:bg-white/50 "
