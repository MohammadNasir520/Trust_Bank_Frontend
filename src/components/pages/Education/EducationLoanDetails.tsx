  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold text-[#012169]">Education Loan</h1>
      ...
      <div className="mb-6">
        ...
        <span className="flex items-center mb-2">
          ...
          />
          <span className="ml-2">Description of the purpose and objective for education loans...</span>
        </span>
      </div>
          ...
          <li>
            <span className="flex items-center  mb-2">
              <FaArrowRight
                ...
                style={{ padding: '4px', height: '20px', width: '20px' }}
              />
              <span className="ml-2">Eligibility criteria for students, parents, and educational institutions...</span>
            </span>
          </li>
        ...
        <p>
          <span className="flex items-center mb-2">
            <FaArrowRight
              ...
              style={{ padding: '4px', height: '20px', width: '20px' }}
            />
            <span className="ml-2">Description of interest rates for education loans...</span>
          </span>
        </p>
      </div>
        ...
        <p>
          <span className="flex items-center mb-2">
            <FaArrowRight
              ...
              style={{ padding: '4px', height: '20px', width: '20px' }}
            />
            <span className="ml-2">Repayment details for education loans...</span>
          </span>
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <ul>
          {/* Add security details for education loans */}
          <li>
            <span className="flex items-center mb-2">
              <FaArrowRight
                className="text-white rounded-full bg-[#ffcc25]"
                style={{ padding: '4px', height: '20px', width: '20px' }}
              />
              <span className="ml-2">Security details for education loans...</span>
            </span>
          </li>
        </ul>
      </div>
      ...
      <p className="text-md">
        <span className="flex items-center mb-2">
          <span className="ml-2">* Additional information for education loans...</span>
        </span>
      </p>
