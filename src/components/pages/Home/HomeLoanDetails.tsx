  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-bold text-[#012169]">Home Loans</h1>
      ...
      <div className="mb-6">
        ...
        <span className="flex items-center mb-2">
          ...
          />
          <span className="ml-2">For Home needs such as education, medical expenses, wedding, travel, etc.</span>
        </span>
      </div>
          ...
          <li>
            <span className="flex items-center mb-2">
              <FaArrowRight
                ...
                style={{ padding: '4px', height: '20px', width: '20px' }}
              />
              <span className="ml-2">Home Line of Credit</span>
            </span>
          </li>
        </ul>
      </div>
          ...
          <li>
            <span className="flex items-center mb-2">
              <FaArrowRight
                ...
                style={{ padding: '4px', height: '20px', width: '20px' }}
              />
              <span className="ml-2">No specific collateral required for Home loans.</span>
            </span>
          </li>
        </ul>
      </div>
